...
### Easily Generate a Favicon file-set using this website 
1. Go to favicon.io 
2. Generate a favicon from an uploaded .png file 
3. Download the folder.zip it gives you after its finished
4. Add the folder contents to your site root OR ./assets/favicon (personal preference)
5. Add these lines to the \<head\> ... \<head\/\>
````html
<head>
    ...
    <!-- CUSTOM FAVICON REFERENCE CODE---Some sources say to add a . before the root folder / -->
